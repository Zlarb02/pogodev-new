...
export function Header() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Navigation */}
      <div
        className={`lg:hidden bg-card/95 backdrop-blur-sm border-b border-border w-full ${
      ...
      >
        <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
          ...
          <a
            href="#contact"
            onClick={handleNavClick}
            className="w-full text-center px-5 py-2 bg-accent text-accent-foreground font-medium rounded-full hover:bg-accent/90 transition-colors"
          >
            Contact
          </a>
        </div>
