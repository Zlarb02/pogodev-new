  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "rounded-lg border bg-background px-4 py-2 shadow-md chart-animation-fadeIn",
          "transition-all duration-200 opacity-100 select-none",
          className
        )}
      >
                  ...
                  <>
                    {itemConfig?.icon ? (
                      ...
                      !hideIndicator && (
                        <div
                          className={cn(
                            "shrink-0 rounded-[2px] border border-background/10",
                            {
          ...
          return (
            ...
            >
              {itemConfig?.icon && !hideIcon ? (
                ...
                <div
                  className="h-2.5 w-2.5 shrink-0 rounded-[2px] border border-background/20 shadow-sm"
                  style={{
                    backgroundColor: item.color,
                  }}
                />
              )}
              <span className="font-medium text-[0.75rem] tracking-tight">
                {itemConfig?.label}
              </span>
            </div>
          );
